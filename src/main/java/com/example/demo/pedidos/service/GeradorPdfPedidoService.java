...
public class GeradorPdfPedidoService {
    ...
    private String montarHtmlPedido(PedidoEntity pedido) {
        ...
        html.append("<tr>")
                ...
                .append("</span></td>")
                .append("</tr><tr>")
                .append("<td><span class='label'>").append(ColunasPedido.LABEL_CPF)
                .append("</span><span class='value'>")
                .append(FormatacaoUtil.formatarCpf(pedido.getCpf()))
                .append("</span></td>")
                .append("<td><span class='label'>").append(ColunasPedido.LABEL_RG)
                .append("</span><span class='value'>")
                .append(FormatacaoUtil.formatarRg(pedido.getRg()))
                .append("</span></td>")
                .append("<td><span class='label'>").append(ColunasPedido.LABEL_CNPJ)
                .append("</span><span class='value'>")
                .append(FormatacaoUtil.formatarCnpj(pedido.getCnpj()))
                .append("</span></td>")
                .append("</tr><tr>")
                .append("<td colspan='2'><span class='label'>").append(ColunasPedido.LABEL_EMAIL)
                .append("</span><span class='value'>")
        ...
        html.append("<tr>")
                ...
                .append("</span></td>")
                .append("<td><span class='label'>").append(ColunasPedido.LABEL_INSCRICAO_ESTADUAL)
                .append("</span><span class='value'>")
                .append(valor(pedido.getInscricaoEstadual()))
                .append(" / ")
        ...
        html.append("<table class='content-table'>");
        html.append("<tr>")
                .append("<td><span class='label'>").append(ColunasPedido.LABEL_ACABAMENTO)
                .append("</span><span class='value'>")
                .append(valor(pedido.getAcabamento()))
                .append("</span></td>")
                .append("<td><span class='label'>").append(ColunasPedido.LABEL_TUBOS)
                .append("</span><span class='value'>")
                .append(valor(pedido.getTubos()))
                .append("</span></td>")
                .append("<td><span class='label'>").append(ColunasPedido.LABEL_REVESTIMENTO)
                .append("</span><span class='value'>")
        ...
        html.append("<tr>")
                ...
                .append("</span></td>")
                .append("<td><span class='label'>").append(ColunasPedido.LABEL_VALOR_TOTAL)
                .append("</span><span class='value'>R$ ")
