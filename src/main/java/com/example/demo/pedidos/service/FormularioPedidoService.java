...
public class FormularioPedidoService {
    ...
    public FormularioPedidoService(ConsultaLocalidades consultaLocalidades) {
    ...
    public FormularioPedido criarFormularioDePedido(Pedido pedido) {
    ...
    public void aplicarFormularioNoPedido(FormularioPedido formularioPedido, Pedido pedido) {
