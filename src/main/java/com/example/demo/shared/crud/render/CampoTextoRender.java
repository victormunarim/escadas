...
public record CampoTextoRender(
    ...
    public CampoTextoRender(
            String rotulo, String name, String classeCampo, String type,
            boolean required, Integer maxLength, String inputMode, String placeholder, Object value
    ) {
